...
pub const DELETE_PROVIDER: Selector<()> = Selector::new("sidenotes.delete-provider");
pub const SAVE_CALENDAR: Selector<()> = Selector::new("sidenotes.save-calendar");
pub const DELETE_CALENDAR: Selector<()> = Selector::new("sidenotes.delete-calendar");
